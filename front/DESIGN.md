...
> **DQPM 앱 매핑** — 구현: `src/styles/cursorSiteTokens.ts`, `design-system.ts`, `DqpmTag`. 폰트: CursorGothic → **Inter** + Noto Sans KR, 코드 → **JetBrains Mono**. 카탈로그: `npm run storybook`. 인덱스: `docs/DESIGN-SYSTEM.md`.
