...
| **이벤트 템플릿** | `event_template.view` | 이벤트 템플릿 보기 | 목록·상세 조회 |
| | `event_template.create` | 이벤트 템플릿 생성 | 새로운 이벤트 템플릿 추가 |
| | `event_template.edit` | 이벤트 템플릿 수정 | 관리-수정 |
| | `event_template.delete` | 이벤트 템플릿 삭제 | 관리-삭제 |
...
| | `my_dashboard.edit` | 인스턴스 수정 | 작성 중인 본인 인스턴스 수정 |
...
| 구분 | 기능 | 설명 | 제안 권한 |
|------|------|------|-----------|
| 보기 | 이벤트 템플릿 보기 | 목록 조회, 상세 조회 | `event_template.view` |
| 생성 | 이벤트 템플릿 생성 | 새로운 이벤트 템플릿 추가(추가 버튼 → 모달) | `event_template.create` |
| 수정 | 이벤트 템플릿 수정 | 관리-수정(수정 버튼 → 모달) | `event_template.edit` |
...
| 수정 | 인스턴스 수정 | event_created 상태, 본인이 생성한 인스턴스만 수정 버튼 | `my_dashboard.edit` (현재 `instance.create` + 본인) |
